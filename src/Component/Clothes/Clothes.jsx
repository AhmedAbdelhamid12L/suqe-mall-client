...
class Clothes extends Component {
  ...
  render() {
    return (
      <>
        <h1>Our Clothes Products</h1>
        <div className="product">{this.displayProducts(this.props.selected)}</div>
      </>
    );
  }
}

export default graphql(getCategoriesQuery)(Clothes);
